...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <form:form action="/produto/update" method="POST" modelAttribute="produtoUpdate" >
          ...
          <spring:bind path="id">
           ...
           <spring:bind path="description">
            ...
            <spring:bind path="fabricante">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="fabricante" class="form-control" placeholder="Fabricante do produto"
                                autofocus="true"></form:input>
