...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <form:form action="/produto" method="POST" modelAttribute="produtoForm" >
           ...
           <spring:bind path="description">
            ...
            <spring:bind path="fabricante">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="fabricante" class="form-control" placeholder="Fabriante do produto"
                                autofocus="true"></form:input>
